...
const moduleMap = {'react':{get:()=>()=>__federation_import(new URL('__federation_shared_react-CfyVo0iz.js', import.meta.url).href),import:true},'react-dom':{get:()=>()=>__federation_import(new URL('__federation_shared_react-dom-BhIJzl5g.js', import.meta.url).href),import:true},'@mui/material':{get:()=>()=>__federation_import(new URL('__federation_shared_@mui/material-qGYtdVAO.js', import.meta.url).href),import:true},'zustand':{get:()=>()=>__federation_import(new URL('__federation_shared_zustand-JC4knwwj.js', import.meta.url).href),import:true},'@moderepo/bizstack-console-sdk':{get:()=>()=>__federation_import(new URL('__federation_shared_@moderepo/bizstack-console-sdk-D9CXhkca.js', import.meta.url).href),import:true}};
